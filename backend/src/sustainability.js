...
const sustainabilitySchema = z.object({
  materials: z
    .number()
    .describe(
      "A number ranging from 0.0 to 10.0 indicating an estimated score of the product's materials sustainability, where 0.0 is very poor and 10.0 is excellent."
    ),
  materialsDetails: z
    .string()
    .describe(
      "A detailed explanation of the factors contributing to the product's materials sustainability score."
    ),

  packaging: z
    .number()
    .describe(
      "A number ranging from 0.0 to 10.0 indicating an estimated score of the product's packaging sustainability, where 0.0 is very poor and 10.0 is excellent."
    ),
  packagingDetails: z
    .string()
    .describe(
      "A detailed explanation of the factors contributing to the product's packaging sustainability score."
    ),

  carbonFootprint: z
    .number()
    .describe(
      "A number ranging from 0.0 to 10.0 indicating an estimated score of the product's carbon footprint, where 0.0 is very low and 10.0 is very high."
    ),
  carbonFootprintDetails: z
    .string()
    .describe(
      "A detailed explanation of the factors contributing to the product's carbon footprint score."
    ),

  waterUsage: z
    .number()
    .describe(
      "A number ranging from 0.0 to 10.0 indicating an estimated score of the product's water usage during its lifecycle, where 0.0 is very low and 10.0 is very high."
    ),
  waterUsageDetails: z
    .string()
    .describe(
      "A detailed explanation of the factors contributing to the product's water usage score."
    ),

  recyclability: z
    .number()
    .describe(
      "A number ranging from 0.0 to 10.0 indicating an estimated score of the product's recyclability, where 0.0 is not recyclable and 10.0 is fully recyclable."
    ),
  recyclabilityDetails: z
    .string()
    .describe(
      "A detailed explanation of the factors contributing to the product's recyclability score."
    ),

  ethicalLaborPractices: z
    .number()
    .describe(
      "A number ranging from 0.0 to 10.0 indicating an estimated score of the product's adherence to ethical labor practices, where 0.0 is poor and 10.0 is excellent."
    ),
  ethicalLaborPracticesDetails: z
    .string()
    .describe(
      "A detailed explanation of the factors contributing to the product's ethical labor practices score."
    ),
});
...
sustainabilityModuleRouter.get("/sustanability/bulk", async (req, res) => {
  ...
  if (!data) {
    return res
      .status(400)
      .json({ error: "Missing required query parameters: data" });
  }
  let products;
  try {
  ...
  if (!Array.isArray(products)) {
    return res.status(400).json({
      error: "Data parameter should be a JSON array of product names",
    });
  }
  ...
  for (const product of products) {
    try {
      ...
      console.error(
        `Error generating sustainability report for ${product}:`,
        error
      );
      results.push({
        product,
